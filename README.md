...
| | |
|---|---|
| **남긴다** | 사진 한 장 + **그때 아이가 한 말** + 만든 날. 등록은 언제나 열려 있습니다 |
...
- **책이 부가 기능이 아니라 목적입니다.** 화면 속 데이터로는 실물을 버릴 결심이 서지 않습니다.
  손에 잡히는 것이 손에 잡히는 것을 대신해야 합니다.
- **아이의 말이 콘텐츠의 핵심입니다.** 그림만 보면 **절대 알 수 없는 것**이
  시드 10장 중 **7장**에 있었습니다 — 톱니 같은 이빨이 *"다 웃는 거야"*이고,
  얼굴을 가로지른 선이 *"이불"*이고, 몸통이 없는 건 *"옷 입고 있으니까 안 보이잖아"*입니다.
...
[서비스 소개](#누가-씁니다)의 **세 줄**(33세 부모 · 30초 · 폰 세로 한 손)이
화면의 거의 모든 결정을 정했습니다.
